                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample"  action="{{route('storepost')}}" method="post" enctype="multipart/form-data">
                          {{ csrf_field() }}
                          
                          
                          <div class="form-group">
                        
                            <select name="user_id" id=""  class="form-control"  id="exampleInputName1">
                          ...
                          <div class="form-group">
                            <input type="text" class="form-control"  id="exampleInputName1" placeholder="Title" name="titel">
                          </div>
                           ...
                           {{-- /// --}}
                           <div class="form-group">
                            <textarea type="text" class="form-control"  id="exampleInputName1" placeholder="Content" name="content"></textarea>
                          </div>
                          {{-- //// --}}
                         

                          <div class="form-group">
                            <input type="text" class="form-control"  id="exampleInputName1" placeholder="Tags" name="tags">
                          </div>
