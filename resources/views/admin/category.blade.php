  ...
  <body>
    ...
    @include('admin.layouts.nav')
            ...
            <div class="page-header">
             ...
             {{-- table start --}}
                ...
                <div style="overflow-x:auto;">
                  ...
                  <a type="button" class="btn btn-success" href="{{route('categoryadd')}}"><i class="fa-solid fa-plus" ></i></a>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="col-md-3 col-xs-3">Details</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$cate->titel}}</td>
                      <td>{{$cate->details}}</td>
                      <td> <img src="{{asset('images/category').'/'.$cate->img .'/'.$cate->img}}" alt=""> </td>
                      
                      <td><a href="{{route('categoryedit',$cate->id)}}"><i class="fas fa-edit"></i></a> </td>
                      <td>  <button style="border: none" data-toggle="modal" data-target="#exampleModal{{$cate->id}}">
      ...
      {{-- modal of delete  --}}
         ...
         <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Delete : {{$cate->titel}}</h5>
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-primary" href="{{route('deletecategory',$cate->id)}}">Yes sure !</a>
      </div>
    </div>
  </div>
</div>
